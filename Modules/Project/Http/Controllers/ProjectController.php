...
class ProjectController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('project::project.create')
            ->with(compact('users', 'customers', 'statuses', 'categories', 'busines'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input['custom_field1'] = !empty($request->input('custom_field1')) ? $request->input('custom_field1') : null;
            $input['custom_field2'] = !empty($request->input('custom_field2')) ? $request->input('custom_field2') : null;
            $input['custom_field3'] = !empty($request->input('custom_field3')) ? $request->input('custom_field3') : null;
            $input['custom_field4'] = !empty($request->input('custom_field4')) ? $request->input('custom_field4') : null;
    ...
    public function show($id)
    {
        ...
        return view('project::project.show')
            ->with(compact('project', 'project_members', 'statuses', 'due_dates', 'priorities', 'timelog', 'can_crud_task', 'can_crud_docus_note', 'can_crud_timelog', 'is_lead_or_admin', 'transaction', 'invoice', 'tab_view', 'busines'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('project::project.edit')
            ->with(compact('users', 'customers', 'statuses', 'project', 'categories', 'busines'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if (! empty($project_members['attached'])) {
                ...
                $project['link'] = action([\Modules\Project\Http\Controllers\ProjectController::class, 'show'], ['project' => $project->id]);
