...
Route::prefix('connector/api')->group(function () {
    Route::get('business/{business_id}/products', [Modules\Connector\Http\Controllers\Api\ProductController::class, 'getBusinessProducts']);

    // Store configuration - public access
    Route::get('store/config/{storeName}', [Modules\Connector\Http\Controllers\Api\StoreConfigurationController::class, 'getByStoreName']);
});

// Admin endpoints - authentication required
Route::middleware('auth:api')->prefix('connector/api')->group(function () {
    // Store configuration - admin only
    Route::get('store/config/business/{business_id}', [Modules\Connector\Http\Controllers\Api\StoreConfigurationController::class, 'getByBusinessId']);
    Route::post('store/config', [Modules\Connector\Http\Controllers\Api\StoreConfigurationController::class, 'store']);
    Route::put('store/config/{id}', [Modules\Connector\Http\Controllers\Api\StoreConfigurationController::class, 'update']);
    Route::post('store/config/{id}', [Modules\Connector\Http\Controllers\Api\StoreConfigurationController::class, 'update']); // Alternative to PUT for file uploads
});
