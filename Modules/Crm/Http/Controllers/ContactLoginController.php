        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($contact_logins)
                ->addColumn('action', function ($row) {
                    ...
                    $html .= '<li><a href="#" class="edit-contact-login" data-href="' . url('crm/contacts-login/' . $row->id . '/edit') . '" style="display: block; padding: 10px 16px; color: #e5e7eb; text-decoration: none;"><i class="fas fa-edit" style="margin-right: 10px; width: 16px;"></i> ' . __('messages.edit') . '</a></li>';
                    $html .= '<li style="height: 1px; margin: 6px 0; background: rgba(255,255,255,0.1);"></li>';
                    $html .= '<li><a href="#" class="delete-contact-login" data-href="' . url('crm/contacts-login/' . $row->id) . '" style="display: block; padding: 10px 16px; color: #e5e7eb; text-decoration: none;"><i class="fas fa-trash" style="margin-right: 10px; width: 16px;"></i> ' . __('messages.delete') . '</a></li>';
                    $html .= '</ul></div>';
