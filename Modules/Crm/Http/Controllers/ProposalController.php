        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($proposals)
                ->addColumn('action', function ($row) {
                    ...
                    $html .= '<li><a href="#" class="view-proposal" data-href="' . url('crm/proposals/' . $row->id) . '" style="display: block; padding: 10px 16px; color: #e5e7eb; text-decoration: none;"><i class="fas fa-eye" style="margin-right: 10px; width: 16px;"></i> ' . __('messages.view') . '</a></li>';
                    $html .= '<li><a href="#" class="edit-proposal" data-href="' . url('crm/proposals/' . $row->id . '/edit') . '" style="display: block; padding: 10px 16px; color: #e5e7eb; text-decoration: none;"><i class="fas fa-edit" style="margin-right: 10px; width: 16px;"></i> ' . __('messages.edit') . '</a></li>';

                    if ($row->status === 'draft') {
                        $html .= '<li><a href="#" class="send-proposal" data-href="' . url('crm/proposals/send/' . $row->id) . '" style="display: block; padding: 10px 16px; color: #e5e7eb; text-decoration: none;"><i class="fas fa-paper-plane" style="margin-right: 10px; width: 16px;"></i> ' . __('crm::lang.send_proposal') . '</a></li>';
                    }

                    $html .= '<li style="height: 1px; margin: 6px 0; background: rgba(255,255,255,0.1);"></li>';
                    $html .= '<li><a href="#" class="delete-proposal" data-href="' . url('crm/proposals/' . $row->id) . '" style="display: block; padding: 10px 16px; color: #e5e7eb; text-decoration: none;"><i class="fas fa-trash" style="margin-right: 10px; width: 16px;"></i> ' . __('messages.delete') . '</a></li>';
                    $html .= '</ul></div>';
