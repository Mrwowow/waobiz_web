...
@section('content')
    ...
    <section class="content">
        ...
        @component('components.widget', ['class' => 'box-primary', 'title' => __('messages.settings') . ':'])
                    ...
                    <div class="tab-pane" id="cn_2">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <button type="submit"
                                        class="tw-dw-btn tw-dw-btn-error tw-text-white tw-dw-btn-lg">@lang('messages.save')</button>
                                </div>
                            </div>
                            {!! Form::close() !!}
                        </div>
                    ...
                    <div class="tab-pane" id="cn_3">
                        <div class="row">
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        {!! Form::label('text_after_table', __('hms::lang.text_after_table')) !!}
                                        {!! Form::textarea('text_after_table', $settings->booking_pdf->text_after_table ?? null, [
                                            'class' => 'form-control',
                                            'id' => 'text_after_table',
                                            'rows' => '4',
                                            'placeholder' => __('hms::lang.text_after_table'),
                                        ]) !!}
                                    </div>
                                </div>
                                <div class="col-md-12">
            ...
            <div class="col-xs-12">
                <p class="help-block"><i>{!! __('hms::lang.version_info', ['version' => $module_version]) !!}</i></p>
            </div>
        @endcomponent
    </section>
    <!-- /.content -->
