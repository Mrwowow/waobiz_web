<tr>
    ...
    <td> 
        <button type="button" class="tw-dw-btn tw-dw-btn-error tw-text-white tw-dw-btn-sm remove"><i class="fas fa-trash-alt"></i></button> 
        <button type="button" class="tw-dw-btn tw-dw-btn-success tw-text-white tw-dw-btn-sm copy"><i class="fas fa-copy"></i></button> 
    </td> 
</tr>